<?php
require_once '../koneksi/koneksi.php';  // Pastikan ini merujuk ke file koneksi yang benar
session_start();
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Menyiapkan query dengan prepared statements untuk menghindari SQL injection
    $sql = "SELECT * FROM admins WHERE username = ?";  // Ganti admin dengan admins

    // Periksa apakah query berhasil dipersiapkan
    $stmt = $conn->prepare($sql);
    if ($stmt === false) {
        die("Error preparing the query: " . $conn->error);  // Tampilkan pesan jika query gagal dipersiapkan
    }
